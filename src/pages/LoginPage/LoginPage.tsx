...
const LoginPage: FC = () => {
    ...
    return <>
        ...
        <div className="for-btn text-center">
            <a href="https://www.linkedin.com/oauth/v2/authorization?response_type=code&amp;client_id=782l68t2mkud14&amp;scope=r_liteprofile&amp;redirect_uri=https://rickandmorty-linkedin.herokuapp.com/login">
                <img
